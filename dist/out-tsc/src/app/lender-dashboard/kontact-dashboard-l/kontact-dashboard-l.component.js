...
var KontactDashboardLComponent = /** @class */ (function () {
    function KontactDashboardLComponent(allBanksService, spinner, toastr, lenderDashboardService, authenticateServiceService, router) {
    ...
    KontactDashboardLComponent.prototype.ngOnInit = function () {
    ...
    KontactDashboardLComponent.prototype.GetAllBanksWithInterestRateHorizontaly = function (orderBy) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        debugger;
                        this.spinner.show();
                        return [4 /*yield*/, this.allBanksService.GetAllBanksWithInterestRateHorizontalyForKontactUser(orderBy + ' desc')];
                    case 1:
                        rates = _a.sent();
    ...
    KontactDashboardLComponent.prototype.GetAllBanksWithInterestRateHorizontalyOrderByColumnName = function (columnName) {
        return __awaiter(this, void 0, void 0, function () {
            var rates;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    KontactDashboardLComponent.prototype.GetHighestRates = function () {
        debugger;
    ...
    KontactDashboardLComponent.prototype.Logout = function () {
        //if(confirm("Are you sure you want to log out?")){
        this.authenticateServiceService.ClearSession();
        this.router.navigate(['/login']);
        //}
    };
    KontactDashboardLComponent = __decorate([
        Component({
            selector: 'app-kontact-dashboard-l',
            templateUrl: './kontact-dashboard-l.component.html',
            styleUrls: ['./kontact-dashboard-l.component.css']
        }),
    ...
    return KontactDashboardLComponent;
}());
export { KontactDashboardLComponent };
//# sourceMappingURL=kontact-dashboard-l.component.js.map