...
var KontactDashboardComponent = /** @class */ (function () {
    function KontactDashboardComponent(allBanksService, spinner, toastr, lenderDashboardService, authenticateServiceService, router) {
    ...
    KontactDashboardComponent.prototype.ngOnInit = function () {
    ...
    KontactDashboardComponent.prototype.GetAllBanksWithInterestRateHorizontaly = function (orderBy) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        debugger;
                        this.spinner.show();
                        return [4 /*yield*/, this.allBanksService.GetAllBanksWithInterestRateHorizontalyForKontactUser(orderBy)];
                    case 1:
                        rates = _a.sent();
    ...
    KontactDashboardComponent.prototype.GetAllBanksWithInterestRateHorizontalyOrderByColumnName = function (columnName) {
        return __awaiter(this, void 0, void 0, function () {
            var rates;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    KontactDashboardComponent.prototype.GetHighestRates = function () {
        debugger;
    ...
    KontactDashboardComponent.prototype.RegisterAsPartner = function () {
        this.authenticateServiceService.ClearSession();
        this.router.navigate(['/registration/', this.lenderDashboardService.userId, 'KT']);
    };
    KontactDashboardComponent.prototype.Logout = function () {
        //if(confirm("Are you sure you want to log out?")){
        this.authenticateServiceService.ClearSession();
        this.router.navigate(['/login']);
        //}
    };
    KontactDashboardComponent = __decorate([
        Component({
    ...
    return KontactDashboardComponent;
}());
export { KontactDashboardComponent };
//# sourceMappingURL=kontact-dashboard.component.js.map